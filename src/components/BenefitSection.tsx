...
export const BenefitSection = () => {
  return (
    <section className="py-32 bg-platinum border-t border-navy/5 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-32">
          ...
          <p className="text-[10px] font-mono text-cobalt tracking-[0.5em] uppercase">The Architectural Advantage</p>
        </div>
            ...
            >
              ...
              <div className="absolute inset-0 bg-white/20 flex items-center justify-center">
                <div className="w-[80%] h-[80%] border border-white/20 rounded-full flex items-center justify-center backdrop-blur-[2px]">
                  <span className="text-2xl md:text-3xl font-display font-bold text-white tracking-tighter uppercase">{item.text}</span>
                </div>
              </div>
            </motion.div>
          ))}
